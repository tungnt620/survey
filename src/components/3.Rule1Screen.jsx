    ...
    <div className='flex flex-col w-full h-screen'>
      <div className='flex flex-col justify-center w-full h-full items-center'>
        ...
        <div className='pr-16 pl-16'>
          ...
          <UnorderedList>
            <ListItem>Bạn sẽ được chi trả một số tiền trong khoảng 5,000VND đến 290,000VND sau 1 ngày.</ListItem>
            <ListItem>Tổ chức thiện nguyện mà bạn lựa chọn sẽ được chi trả khoảng tiền từ 50,000 VND cho đến 290,000VND
              sau khoảng thời gian từ 3 ngày cho đến 60 ngày.</ListItem>
          </UnorderedList>
          <div className='mt-4'>
            Vui lòng chọn tổ chức thiện nguyện mà bạn muốn nhóm nghiên cứu chi trả:
          </div>
          <FormControl width='400px' isInvalid={!!formErrors.fieldA}>
            <Select value={formData.fieldA} onChange={(event) => {
      ...
      <div className='flex mb-4 mr-4'>
        ...
        <Button onClick={onNext} disabled={Object.values(formErrors).some((error) => !!error)} colorScheme='blue'
