...
const PlayerInformationScreen = ({sendMachineEvent}) => {
  const {formData, formErrors, validate, setFieldValue} = useFormValidator({
    ...
    rules: {
      ...
      yearOfBirth: [formRules.required(), formRules.number(), formRules.maxLength(4), formRules.minLength(4)],
    }
  })
    ...
    <div className='flex flex-col w-full h-screen'>
      <div className='flex flex-col justify-center w-full h-full items-center'>
        ...
        <div className='font-bold text-xl mb-8'>
          Phần I: Thông Tin Nhân Khẩu Học (do I need to blind myself from this information?)
        </div>
        <div>
          ...
          <FormControl className='mt-4' width='400px' isInvalid={!!formErrors.yearOfBirth}>
            <FormLabel>Năm sinh</FormLabel>
            <Input type='number' value={formData.yearOfBirth} onChange={(event) => {
