  ...
  return (
    <div className='flex flex-col w-full h-screen'>
      <div className='flex flex-col justify-center w-full h-full items-center'>
        ...
        <div>
          Người khảo sát: Nguyễn Minh Hiếu
        </div>
        <div>
          Email: <a className='text-cyan-400'
                    href="mailto:mpp23.hieunguyen@student.fulbright.edu.vn">mpp23.hieunguyen@student.fulbright.edu.vn</a>
        </div>
        <div>
          SĐT: 0909967688
        </div>
      ...
      <div className='flex mb-4 mr-4'>
        ...
        <Button onClick={() => sendMachineEvent('NEXT')} colorScheme='blue' className='font-bold text-lg'>
          Bắt đầu
        </Button>
      </div>
    </div>
